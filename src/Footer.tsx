        ...
        <>
            <footer>
                ...
                <div className="footer-text">
                    ...
                    <a href="https://www.instagram.com/down_the_amo/"><h3><i className="fa fa-instagram" aria-hidden="true"></i> @down_the_amo</h3></a>
                </div>
            </footer>
        </>
    );
